...
SOURCES            = main.c myLib.c StartScreen.c PauseScreen.c GameScreen.c PoohBearSprites.c FrontLayer.c Instructions.c game.c CollisionMap.c WinScreen.c LoseScreen.c sound.c HoneyPotSound.c GameSound.c WinnieTitleSong.c WinSound.c LoseSound.c Story1.c StateFunctions.c draw.c
